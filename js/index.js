...
//img notification
var contactImPreview = document.getElementById("img_preview");
...
contactImgToSet.addEventListener("change", (event) => {
  contactImPreview.src = URL.createObjectURL(contactImgToSet.files[0]);
});
